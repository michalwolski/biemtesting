...
public class Change_password_fail {
...
//		capabilities.setCapability("newCommandTimeout", 7200);
		...
		capabilities.setCapability("autoAcceptAlerts", true);
		capabilities.setCapability("name", "Change password fail test");
	...
	@Test
	public void change_password_fail_test() throws InterruptedException
	{		
		//logowanie start
		...
		wd.findElement(By.xpath("//UIAApplication[1]/UIAWindow[1]/UIAScrollView[2]/UIAScrollView[1]/UIAElement[2]")).click();
		((IOSElement) wd.findElement(By.xpath("//UIAApplication[1]/UIAWindow[1]/UIAScrollView[2]/UIAScrollView[1]/UIASecureTextField[1]"))).setValue("osim88881234");
		wd.hideKeyboard("Return");
		((IOSElement) wd.findElement(By.xpath("//UIAApplication[1]/UIAWindow[1]/UIAScrollView[2]/UIAScrollView[1]/UIASecureTextField[2]"))).setValue("osim12345");
		wd.hideKeyboard("Return");
		WebElement done = wd.findElement(By.xpath("//UIAApplication[1]/UIAWindow[1]/UIAScrollView[2]/UIAScrollView[1]/UIAElement[1]"));
		if (done.isDisplayed()){
			done.click();
			Reporter.log("Change password button clicked");
			System.out.println("Change password button clicked");
		}
		try {
			done = wd.findElement(By.xpath("//UIAApplication[1]/UIAWindow[1]/UIAScrollView[2]/UIAScrollView[1]/UIAElement[1]"));
			Reporter.log("Change password failed");
			System.out.println("Change password failed");
		}
		 catch (Exception e) {
			    Reporter.log("Change password successfull");
